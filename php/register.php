...
//need to handle the onclick attribute to call the javascript method in order for the registration to work!
        ...
        <div class="main_div">
         ...
         <!-- <img id="banner" src= "../images/booksalesjsu.png"> -->
          ...
          <div class="user-info" id="registration-height">
            <h2>Register</h2>       
            <form action="register.php" id="registrationForm" name="registrationForm" method="post" onsubmit="return validateRegistration()">
